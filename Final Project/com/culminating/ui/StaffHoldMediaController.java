 ...
 * Name: Grace
 * Date: 2022-05-04
 * Description: StaffHoldMediaController class, staff can see all the hold medias in system.
 */
...
public class StaffHoldMediaController {
	...
	@FXML
	private TableColumn<ItemStatus, String> holdByColumn;
	
	/**
	 * All hold medias by all users.
	 */
	...
	public void initData(User user) {
		...
		holdMedias = FXCollections.observableArrayList(allHolds);
		...
		holdByColumn.setCellValueFactory(new PropertyValueFactory<>("userName"));
	 ...
	 */
	@FXML
	protected void removeMedia(ActionEvent event) {
		if (selectedItems != null && selectedItems.get(0) != null) {
